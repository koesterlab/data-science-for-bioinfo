...
## choice of coding tool

**Posit PBC (formerly RStudio) are developing the integrated development environment [Positron](https://positron.posit.co/) as a more modern replacement for RStudio, also integrating Python support.**
**Please see the respective [Positron section of the IDE page](../coding_tools/ide.md#positron).**

Previously, Rstudio was the recommended IDE for R, as it was the most comprehensive IDE for this language and very easy to get going with a productive workflow.
You can still get the free desktop version for your operating system on posit's [Rstudio download page](https://posit.co/download/rstudio-desktop/#download).
...
To follow best practices of readable code syntax, like the above described [style guide](#style-guide), it is best to use a dedicated package.
There are multiple options for R.

### air

`air` is the most recently developed and probably fastest package for automatic formatting of code.
Jump right in by looking at the [`air` documentation](https://posit-dev.github.io/air/), with the [plugin for your code editor of choice](https://posit-dev.github.io/air/editors.html) probably the quickest way to get going.
...
In addition to formatting your R code for readability (and to follow style guide recommendations), you can further lint your code to get suggestions on anything from correctness to performance.

### jarl

[`jarl`](https://jarl.etiennebacher.com/) extends the automatic formatting rules provided by [`air`](#air), with [further rules checking whether code is correct, suspicious, performant, and readable](https://jarl.etiennebacher.com/rules).
It also comes with [integrations for multiple code editors (including VSCode / Positron)](https://jarl.etiennebacher.com/editors) and further [integrations with development tooling](https://jarl.etiennebacher.com/integrations).
